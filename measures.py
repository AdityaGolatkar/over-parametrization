...
def calculate(model, init_model, device, train_loader, margin):
    ...
    with torch.no_grad():
        ...
        # Eigenvalues of the weight matrix in the third layer
        _,S3,_ = modules[4].weight.svd()        
        ...
        # Eigenvalues of the initial weight matrix in the third layer
        _,S03,_ = init_modules[4].weight.svd()
        ...
        # Frobenius norm of the weight matrix in the third layer
        Fro3 = modules[4].weight.norm()
        ...
        # difference of final weights to the initial weights in the third layer
        diff3 = modules[4].weight - init_modules[4].weight
        ...
        Dist2 = diff2.norm()
        # Euclidean distance of the weight matrix in the third layer to the initial weight matrix
        Dist3 = diff3.norm()
        ...
        measure['Frobenius3'] = Fro3
        measure['Distance1'] = Dist1
        measure['Distance2'] = Dist2
        measure['Distance3'] = Dist3
